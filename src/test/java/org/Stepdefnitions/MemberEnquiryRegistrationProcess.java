...
public class MemberEnquiryRegistrationProcess extends Baseclass{
	...
	public void the_user_have_login_with_vaild_credential_organization_user() {
		url("https://202.131.99.210:83/");
		click(r.getLogin());
		sendkeys(r.getUsername(), "b6reqy855u@greencafe24.com");
...
//		Assert.assertEquals("Verify the company name", "Aster Logistic", getattribute(r.getCompanyname()));
